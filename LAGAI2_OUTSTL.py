...
for i in range(nMechDesired):   # liste des cibles mecaniques atteignables
    # génération des STL des lattices générés par le decodeur NN 
    dirFileSTL=output_dir+"lattice_NN"+str(i)

    fileSTL=dirFileSTL+"/"+"LatticeSTL_NN"+str(i)+".stl"
    ...
    # generation des STL des lattices initiaux
    dirFileSTL=output_dir+"lattice_database"+str(i)
    fileSTL=dirFileSTL+"/"+"LatticeSTL_database"+str(i)+".stl"
