...
% Dos Reis F.
% 23.01.2021
% 19.08.2022 modified for create database for GCNN validation

function [ME1,MS4,rho]=homogenization(Tb,L1,L2,Y1,Y2,nbeams,nnodes,nodes,Ob,Eb,...
    delta1,delta2,Elast)
    %% inputs :
...
%         Lb(i)=sqrt(ObEb(1,1)^2+ObEb(1,2)^2); % length of the beam
        ...
        [Lb(i),e(i,:)]=EvaluateLb2(i,indexn1,indexn2,nodes,L1,L2,delta1,delta2);              %*
        Volume_matiere=Volume_matiere+Lb(i)*Tb(i);
%         e(i,1:2)=ObEb/Lb(i);
