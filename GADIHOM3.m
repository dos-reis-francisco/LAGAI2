...
function [bestMS4,bestChromosome,bestAlphaBeta,bestTb,chromosomes,alphaBeta]=GADIHOM3(nchromosomes,nkeep,rhov,nkmax,target,wtarget,mutrate,ntvalue,...
lambda,convergence,nConvergence,sx,nodes,Ob, Eb,delta1,delta2,maillage,L,init_0,chromosomes_0,alphaBeta_0)
%% inputs 
...
% init_0 : 'Y' or 'N', if 'Y' then the genetic algorithm search will be seeded with chromosome_O and alphabeta_0
% chromosome_0 : chromosome seed for genetic algorithm 
% alphabeta_0: alpha_beta seed for genetic algorithm
